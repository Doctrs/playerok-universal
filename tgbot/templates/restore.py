...
def restore_text():
    ...
    txt = textwrap.dedent(f"""
        ...
        <blockquote><b>(?)</b> Если вы выберете "Все товары", то будут восстанавливаться все товары, кроме исключений. Если "Указанные товары" — только включённые (фразы через запятую — все должны быть в названии), минус исключения.</blockquote>
