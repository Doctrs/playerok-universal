...
def complete_text():
    ...
    txt = textwrap.dedent(f"""
        ...
        <blockquote><b>(?)</b> Если вы выберете "Всех товаров", то будут подтверждаться сделки всех товаров, кроме исключений. Если "Указанных товаров" — только включённые (фразы через запятую — все должны быть в названии), минус исключения.</blockquote>
